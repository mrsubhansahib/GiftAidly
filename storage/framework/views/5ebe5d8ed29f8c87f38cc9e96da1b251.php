                                ...
                                <div class="p-4">
                                    <div class="mx-auto mb-4 text-center">
                                        ...
                                        <div class="text-center">
                                            <a href="<?php echo e(route('any', '')); ?>" class="btn btn-danger">Back to Home</a>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end col -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', ['subtitle' => 'Page Not Found - 404'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel\Softic-Era\Current Projects\GiftAidly\resources\views/pages/404.blade.php ENDPATH**/ ?>
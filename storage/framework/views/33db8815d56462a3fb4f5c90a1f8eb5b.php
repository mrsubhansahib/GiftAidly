                        ...
                        <table id="" class="datatable table table-striped table-bordered align-middle">
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($invoice->subscription->user->name); ?></td>
                                        <td><?php echo e($invoice->subscription->user->email); ?></td>
                                        <td>
                                            <?php echo e(match (strtoupper($invoice['currency'])) {
                                                'USD' => '$',
                                                'GBP' => '£',
                                                'EUR' => '€',
                                            }); ?>

                                            <?php echo e(number_format($invoice['amount_due'], 2)); ?>

                                        </td>
                                        <td>
                                            <span class="badge <?php echo e($invoice->paid_at ? 'bg-success' : 'bg-danger'); ?>">
                                                <?php echo e($invoice->paid_at ? 'Paid' : 'Failed'); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <?php echo e(\Carbon\Carbon::parse($invoice->paid_at)->format('Y-m-d')); ?>
                                            ...
                                            <div class="modal-content border-0 rounded-4 shadow-lg">
                                                ...
                                                <div class="modal-header border-0 pb-0">
                                                    <h4 class="modal-title text-dark fw-semibold"
                                                        ...
                                                        Invoice
                                                        #<?php echo e(substr($invoice['stripe_invoice_id'] ?? 'N/A', -8)); ?>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                                        <div>
                                                            ...
                                                            <p class="mb-0 fw-medium">
                                                                <?php echo e($invoice->subscription->user->name ?? 'N/A'); ?></p>
                                                            <small
                                                        ...
                                                        <div class="col-12">
                                                            <div class="text-center p-4 bg-light rounded-3">
                                                                ...
                                                                <h3 class="text-dark fw-bold mb-0">
                                                                    ...
                                                                    <?php echo e(number_format($invoice['amount_due'] ?? 0, 2)); ?>
...
</div><?php /**PATH D:\Laravel\Softic-Era\Current Projects\GiftAidly\resources\views\livewire/user/invoices.blade.php ENDPATH**/ ?>
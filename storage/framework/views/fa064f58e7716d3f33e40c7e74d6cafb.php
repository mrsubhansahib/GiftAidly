    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="topbar-item">
                    <a type="button" href="<?php echo e(route('second', ['donation', 'index'])); ?>"
                    ...
                    <div class="dropdown-menu py-0 dropdown-lg dropdown-menu-end"
                        ...
                        <div data-simplebar style="max-height: 250px;">
                            ...
                            <form action="<?php echo e(route('notifications.read', $notification->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="dropdown-item w-100 text-start p-2 border-bottom text-wrap <?php echo e(isset($notification->read_at) && $notification->read_at ? '' : 'bg-light'); ?>">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            <p class="mb-0 fw-medium"><?php echo e($data['title'] ?? 'Notification'); ?></p>
                                            <p class="mb-0 text-wrap"><?php echo e($data['message'] ?? ''); ?></p>
                ...
                <div class="dropdown topbar-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('third', ['shared', 'profile', 'show'])); ?>">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('third', ['admin', 'change-password', 'index'])); ?>">
...
</header><?php /**PATH D:\Laravel\Softic-Era\Current Projects\GiftAidly\resources\views/layouts/partials/topbar.blade.php ENDPATH**/ ?>
...
state([
    'user' => fn() => Auth::user()->only(['name', 'email', 'title', 'city', 'country', 'address', 'zip_code']),
]);
                ...
                <div class="modal-body px-4 pb-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" wire:model.defer="user.country" class="form-control">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Address</label>
                            <input type="text" wire:model.defer="user.address" class="form-control">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Zip Code</label>
                            <input type="text" wire:model.defer="user.zip_code" class="form-control">
                        </div>
                    </div>

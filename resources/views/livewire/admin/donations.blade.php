            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="donations-table" class="table table-striped table-bordered align-middle">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>User Email</th>
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header text-white">
                                                    <h5 class="modal-title" id="donationModalLabel{{ $donation['id'] }}">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <p><strong>Donation Type:</strong> {{ $donation['type'] }}</p>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <p><strong>Cancel Date:</strong> {{ $donation['cancel_date'] }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

                    ...
                    <form id="form-monthly" action="{{ route('donation.special') }}" method="POST">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="amount" value="{{ old('amount') }}" placeholder="100.00"
                                    readonly id="pay-amount" class="text-input" />
                            ...
                            <div class="form-group"
                                ...
                                <div style="flex: 1; min-width: 200px; display: flex; flex-direction: column;">
                                    <input type="text" name="address" value="{{ old('address') }}"
                                        id="address-monthly" class="text-input" style="display: none; width: 100%;"
                                        placeholder="Enter your address" />

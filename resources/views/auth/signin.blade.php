                            ...
                            <form method="POST" action="{{ route('signin') }}" class="mt-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="email-signin" name="email" placeholder="user@demo.com"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="password-input-container">
                                        <input type="password" class="form-control form-control-password"
                                            id="password-signin" name="password" placeholder="Enter your password" required>
                                        <span class="password-toggle-icon"
                                            onclick="togglePassword('password-signin', this)">
                                ...
                                <div class="d-grid">
                                    <button style="background: linear-gradient(45deg, #1d43ab, #94740dff);"
                                        class="btn btn-lg fw-medium text-light" type="submit">
                                        Sign In
                                    </button>
                                </div>
                            </form>

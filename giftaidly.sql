...
--
-- Table structure for table `special_donations`
--
...
CREATE TABLE `subscriptions` (
  ...
  `gift_aid` enum('yes','no') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'no',
...
ALTER TABLE `product_catalogs`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `product_catalogs_product_id_unique` (`product_id`);
...
--
-- Indexes for table `special_donations`
--
ALTER TABLE `special_donations`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `transactions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `transactions_stripe_transaction_id_unique` (`stripe_transaction_id`),
...
--
-- AUTO_INCREMENT for table `special_donations`
--
ALTER TABLE `special_donations`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
